...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public DaoMaster(Database db) {
        ...
        registerDaoClass(PhoneNumInfoDao.class);
        registerDaoClass(ContactAndHobbyDao.class);
        registerDaoClass(BankCardInfoDao.class);
        registerDaoClass(ContactInfoDao.class);
        registerDaoClass(HobbyInfoDao.class);
        registerDaoClass(IDCardInfoDao.class);
    }
